...
A distributed chat application in Python. Multiple clients join a shared chat room and exchange messages through a group of replicated servers. The system is scalable in the number of clients and tolerates the crash of any single server, including the leader.
